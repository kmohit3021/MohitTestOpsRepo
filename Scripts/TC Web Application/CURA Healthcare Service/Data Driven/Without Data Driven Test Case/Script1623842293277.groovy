...
WebUI.setText(findTestObject('OR Web Application/CURA Healthcare Service/Login Page/input_Username'), 'John Doe')

WebUI.setText(findTestObject('OR Web Application/CURA Healthcare Service/Login Page/input_Password'), 'ThisIsNotAPassword')
