...
WebUI.callTestCase(findTestCase('TC Web Application/CURA Healthcare Service/Appointment/Login Application Self Healing'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.selectOptionByValue(findTestObject('OR Web Application/CURA Healthcare Service/Appointment Page/facility'), Facility, 
    false)
...
WebUI.sendKeys(findTestObject('OR Web Application/CURA Healthcare Service/Appointment Page/Visit Date (Required)'), VisitDate)

WebUI.sendKeys(findTestObject('OR Web Application/CURA Healthcare Service/Appointment Page/Comment_comment'), Comment)
